...
/* Uncomment these first if you just want to confirm messages are arriving.

+heartbeat(A,B,C,D,E,F)
  <-
    .print("heartbeat=", A, ";", B, ";", C, ";", D, ";", E, ";", F).

+attitude(A,B,C,D,E,F,G)
  <-
    .print("attitude=", A, ";", B, ";", C, ";", D, ";", E, ";", F, ";", G).

+sysstatus(A,B,C,D,E,F,G,H,I,J,K,L,M)
  <-
    .print("sysstatus=", A, ";", B, ";", C, ";", D, ";", E, ";", F, ";", G, ";", H,
           ";", I, ";", J, ";", K, ";", L, ";", M).

+statustext(A,B,C,D)
  <-
    .print("statustext=", A, ";", B, ";", C, ";", D).
*/
